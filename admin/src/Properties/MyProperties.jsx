      ...
      const fetchProperties = async () => {
        try {
          ...
          const filteredProperties = data.data.properties.filter(
            property => property.agentId === user._id
          );
        ...
        const updatedMenu = (
          <div className="dropdown">
            ...
            <div className="dropdown-menu">
              ...
              <a className="dropdown-item waves-effect" onClick={()=>{handleDelete(property._id)}}>
          ...
          <div className="content-wrapper">
            <div className="container-xxl flex-grow-1 container-p-y">
              <h4 className="py-3 mb-4">
                <span className="text-muted fw-light">Properties /</span> My properties
