...
const ReportedProperties = () => {
  ...
  const handleReject = (id) => {
    axios
      .patch(`http://localhost:3000/properties/reject/${id}`)
      .then(() => {
        console.log("Property reject successfully");
      })
      .catch((error) => {
        console.error("There was an error reject the property!", error);
      });
  };
    ...
    const updatedMenu = (
      <div className="dropdown">
        ...
        <div className="dropdown-menu">
          ...
          >
            <i className="mdi mdi-check me-1"></i> Unflag
          </a>
          <Link
            to={`/viewProperty/${property._id}`}
            className="dropdown-item waves-effect"
          >
          ...
          <div className="content-wrapper">
            <div className="container-xxl flex-grow-1 container-p-y">
              <h4 className="py-3 mb-4">
                <span className="text-muted fw-light">Properties /</span>{" "}
                Reported properties
              </h4>
              <div className="card">
