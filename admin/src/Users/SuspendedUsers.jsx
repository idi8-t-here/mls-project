      ...
      options: {
        ...
        customBodyRender: (value) => {
            if(value === "verified"){
              ...
              return <span className="badge rounded-pill bg-label-danger me-1">Rejected</span>
          }
            else {
    ...
    const updatedMenu = (
      <div className="dropdown">
        ...
        <a className="dropdown-item waves-effect" onClick={()=>{handleVerify(user._id)}}>
          ...
          <Link to="/createUsers" className="dropdown-item waves-effect">
          ...
          <div className="content-wrapper">
            <div className="container-xxl flex-grow-1 container-p-y">
              <h4 className="py-3 mb-4">
                <span className="text-muted fw-light">Users /</span> Verify
                users
              </h4>
              <div className="card">
